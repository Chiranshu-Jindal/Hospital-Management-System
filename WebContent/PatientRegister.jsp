...
<body bgcolor="#ADD8E6">
	...
	<center>
		<font size=20><b>Patient Registration Form</b></font>
	</center>
	<hr>
			...
			<table bgcolor="#f2f2f2" cellspacing="15px">
				...
				<tr>
					...
					<td><input type="radio" name="gender" value="Male"
						...
						type="radio" name="gender" value="Other" required="required">Other</td>
				</tr>

				<tr>
					<td>Contact No:</td>
					<td><input type="tel" name="contact" pattern="^\d{10}$"
						placeholder="xxxxxxxxx" required="required"></td>
				</tr>
				...
				<tr>
					...
					<td><input type="password" name="password" placeholder="****"
						required="required" id="mypassword"></td>
				</tr>
