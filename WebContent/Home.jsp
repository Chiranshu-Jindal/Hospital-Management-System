...
<body bgcolor="#ADD8E6">
	...
	<div class="topnav" class="containerh">
		...
		<a href="About.jsp">About</a> <a href="Contact.jsp">Contact</a> <a
			href="PatientLogin.jsp">Need Appointment</a>
	</div>

	<marquee style="font-size: 30px;" onmouseover="this.stop();"
		onmouseout="this.start();">
		<blink> &#9733</blink>
		Need an appointment ? <a href="PatientLogin.jsp" style="color: black;">
			Login</a> Or <a href="PatientRegister.jsp" style="color: black;"> Register </a>
	</marquee>
